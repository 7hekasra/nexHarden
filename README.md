...
یک ابزار امنیتی برای سیستم‌های لینوکسی است که با هدف شناسایی تنظیمات ناامن و کمک به هاردنینگ سیستم طراحی شده است.
...
اسکریپت nexHarden سیستم را بررسی کرده و موارد مهم امنیتی و تنظیمات پیشنهادی را نمایش می‌دهد.
...
همچنین میتونید از طریق تلگرام و ایمیل با من در ارتباط باشید.
info@linuxfarci.ir
tel: @mtaal
---
